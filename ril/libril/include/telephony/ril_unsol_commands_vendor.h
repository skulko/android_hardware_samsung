...
*/
    ...
    {RIL_UNSOL_WB_AMR_STATE, radio::wbAMRStateInd, WAKE_PARTIAL}, // 11017
    {RIL_UNSOL_TWO_MIC_STATE, radio::twoMicStateInd, WAKE_PARTIAL}, // 11018
    ...
    {RIL_UNSOL_SNDMGR_WB_AMR_REPORT, radio::wbAMRReportInd, WAKE_PARTIAL}, // 20017
#endif
#ifdef RIL_UNSOL_SNDMGR_CLOCK_CTRL
    {RIL_UNSOL_SNDMGR_CLOCK_CTRL, radio::sndMgrClockCtrlInd, WAKE_PARTIAL}, // 20022
#endif
